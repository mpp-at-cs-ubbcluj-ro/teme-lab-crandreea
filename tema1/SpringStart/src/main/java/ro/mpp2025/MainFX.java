...
public class MainFX extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            ...
            ro.mpp2025.ctrl.ComputerRepairShopController ctrl = loader.getController();
    ...
    static ComputerRepairServices getService() throws ServicesException {
        try {
            ...
            ComputerRepairedFormRepository crfRepo = (ComputerRepairedFormRepository) new ComputerRepairedFormFileRepository(formsFileName, crrRepo);
